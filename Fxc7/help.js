...
\`\`\`GROUP OFFICIAL\`\`\`
https://chat.whatsapp.com/GjssvHyBBqZ4BmRSCUPWxx
...
│➻ *${prefix}croman 𝗞𝗨𝗣𝗥𝗜𝗧 dan Friend*
│➻ *${prefix}slide 𝗞𝗨𝗣𝗥𝗜𝗧 𝗕𝗢𝗧 WA*
├───────────────────
│➻ *${prefix}tp 1 - 162*
│➻ *${prefix}ep 1 - 216*
│➻ *${prefix}tahta FXC7*
...
┴
│√ *PULSA : 082279662097*
│√ *GOPAY : 082279662097/085210241824*
│√ *OVO : 085210241824*
│\`\`\`Pulsa\`\`\`
│ *20k Invite Bot Ke Grup selama 1 bulan*
│
│\`\`\`GOPAY\`\`\`
│ *15k Invite Bot Ke Group Selama 1 Bulan*
┬
╰──────「 *BY ${name}* 」
